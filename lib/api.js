...
passport.use(new GoogleStrategy({
		...
		callbackURL: 'https://' + process.env.HOSTNAME + '/auth/google'
	},
...
app.get('/api/transaction', function (req, res) {
	database.transaction.findAll({ order: ['date', 'ordinal'] }).then(function (transactions) {
...
app.get('/api/bucket/export', function (req, res) {
...
app.post('/api/bucket/import', function (req, res) {
	req.setEncoding('utf8');
