...
module.exports = {
	...
	bucket: [
		/*  1 */ { barrelId: 1, name: 'mortgage', amount: 1234.56, period: 1, periodUnit: 'month', date: month, budget: 'Slush' },
		/*  2 */ { barrelId: 1, name: 'food', amount: 375, period: 7, periodUnit: 'days', date: week, budget: 'Slush' },
		/*  3 */ { barrelId: 1, name: 'internet', amount: 85, period: 1, periodUnit: 'month', date: month, budget: 'Slush' },
		/*  4 */ { barrelId: 1, name: 'train', amount: 270, period: 1, periodUnit: 'month', date: month, budget: 'Slush' },
		/*  5 */ { barrelId: 1, name: 'petrol', amount: 75, period: 7, periodUnit: 'days', date: lastWeek, budget: 'Slush' },
		/*  6 */ { barrelId: 2, name: 'house', amount: 1234.56, period: 1, periodUnit: 'month', date: month, budget: 'Slush' },
		/*  7 */ { barrelId: 2, name: 'eats', amount: 375, period: 7, periodUnit: 'days', date: week, budget: 'Slush' },
		/*  8 */ { barrelId: 2, name: 'bits', amount: 85, period: 1, periodUnit: 'month', date: month, budget: 'Slush' },
		/*  9 */ { barrelId: 2, name: 'choo choo', amount: 270, period: 1, periodUnit: 'month', date: month, budget: 'Slush' },
